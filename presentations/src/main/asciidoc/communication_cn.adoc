...
== Github issue
* 轻量化的 https://docs.github.com/en/issues/tracking-your-work-with-issues/quickstart[开发上下文追踪场景]
** 跟踪想法
** 获取反馈
...
* Github提供了 https://docs.github.com/en/get-started/writing-on-github/working-with-advanced-formatting/autolinked-references-and-urls#issues-and-pull-requests[issue和PR的自动链接]
* 使用emoji来表达态度
